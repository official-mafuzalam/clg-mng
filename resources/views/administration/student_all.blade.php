                            ...
                            <div
                                ...
                                <div>
                                    <div class="inline-flex gap-x-2">
                                        <button
                                            class="py-2 px-3 inline-flex justify-center items-center gap-2 rounded-md border font-medium bg-slate-500 text-gray-700 shadow-sm align-middle hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-white focus:ring-blue-600 transition-all text-sm dark:bg-slate-600 dark:hover:bg-slate-800 dark:border-gray-700 dark:text-gray-950 dark:hover:text-white dark:focus:ring-offset-gray-800"
                                            type="submit">
                                            Search
                                        </button>
                                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="h-px w-px whitespace-nowrap">
                                            <div class="px-4 py-3">
                                                ...
                                                <span class="block text-sm text-gray-500">Pass:
                                                    {{ $student->password }}
                                                </span>
                                            </div>
                                        </td>
                                        <td class="h-px w-px whitespace-nowrap">
                                            <div class="px-4 py-3">
                                                ...
                                                <span class="block text-sm text-gray-500">Session:
                                        ...
                                        <td class="h-px w-px whitespace-nowrap">
                                            <div class="px-4 py-3">
                                                ...
                                                <span class="block text-sm text-gray-500">Clg id:
                                                    {{ $student->clg_id }}
                                                </span>
                                            </div>
                                        </td>
