...
{{-- Page Title --}}
@section('page-title')
    <title>Trashed Teacher | Best Politechnic Institute</title>
@endsection
...
@section('breadcrumb')
    <li>
        <div class="flex items-center">
            ...
            <a href="#"
                class="ml-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ml-2 dark:text-gray-400 dark:hover:text-white">Teachers</a>
        </div>
    </li>
    <li aria-current="page">
        <div class="flex items-center">
            ...
            <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-400">Trashed Teachers</span>
        </div>
    </li>
@endsection
<!-- End Breadcrumb -->
                                        ...
                                        <td class="h-px w-px whitespace-nowrap">
                                            <div class="px-4 py-1.5">
                                                <a class="block items-center gap-x-1.5 text-sm text-blue-600 decoration-2 hover:underline font-medium"
                                                    href="{{ route('administration_teacher.restore', ['id' => $teacher->id]) }}">
                                                    Restore
                                                </a>
                                                <a class="block items-center gap-x-1.5 text-sm text-red-600 decoration-2 hover:underline font-medium"
                                                    href="{{ route('administration_teacher.delete', ['id' => $teacher->id]) }}">
                                                    Delete
                                                </a>
                                            </div>
                                        </td>
