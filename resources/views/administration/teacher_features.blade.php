...
@section('breadcrumb')
    ...
    <li aria-current="page">
        <div class="flex items-center">
            ...
            <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-400">All Teachers</span>
        </div>
    </li>
@endsection
<!-- End Breadcrumb -->
                                        ...
                                        <td class="h-px w-px whitespace-nowrap">
                                            <div class="px-4 py-1.5">
                                                <a class="block items-center gap-x-1.5 text-sm text-blue-600 decoration-2 hover:underline font-medium"
                                                    href="{{ route('administration_teacher.featuresEdit', ['id' => $teacher->id]) }}">
                                                    Edit
                                                </a>
                                            </div>
                                        </td>
