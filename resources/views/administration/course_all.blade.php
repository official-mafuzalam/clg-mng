...
{{-- Page Title --}}
@section('page-title')
    <title>Course All | Best Politechnic Institute</title>
@endsection
...
@section('breadcrumb')
    ...
    <li aria-current="page">
        <div class="flex items-center">
            ...
            <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-400">All Course</span>
        </div>
    </li>
@endsection
<!-- End Breadcrumb -->
                                        ...
                                        <td class="h-px w-px whitespace-nowrap">
                                            <div class="px-4 py-1.5">
                                                <a class="block items-center gap-x-1.5 text-sm text-blue-600 decoration-2 hover:underline font-medium"
                                                    href="{{ route('administration_course.edit', ['id' => $course->id]) }}">
                                                    Edit
                                                </a>
                                                <a class="block items-center gap-x-1.5 text-sm text-red-600 decoration-2 hover:underline font-medium"
                                                    href="{{ route('administration_course.delete', ['id' => $course->id]) }}">
                                                    Delete
                                                </a>
                                            </div>
                                        </td>
