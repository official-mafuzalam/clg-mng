...
<!-- Sidebar Toggle -->
<div
    class="noPrint sticky top-0 inset-x-0 z-20 bg-white border-y px-4 sm:px-6 md:px-8 lg:hidden dark:bg-gray-800 dark:border-gray-700">
...
<div id="application-sidebar"
    ...
    <div class="px-6">
        <a class="flex-none text-xl font-semibold dark:text-white" aria-label="Brand">Welcome!</a>
    </div>
                ...
                <div id="account-accordion-child"
                    ...
                    <ul class="pt-2 pl-2">
                        ...
                        @if (session('user.f_quarry', 'default') == 1)
                            <li>
                                <a class="flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-slate-700 rounded-md hover:bg-gray-100 dark:bg-gray-800 dark:text-slate-400 dark:hover:text-slate-300"
                                    href="{{ route('administration_deposit.check') }}">
                                    Deposit Check
                                </a>
                            </li>
                        @endif
